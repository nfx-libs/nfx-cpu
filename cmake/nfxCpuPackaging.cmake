#==============================================================================
# nfx-cpu - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_CPU_PACKAGE_SOURCE
		AND NOT NFX_CPU_PACKAGE_ARCHIVE
		AND NOT NFX_CPU_PACKAGE_DEB
		AND NOT NFX_CPU_PACKAGE_RPM
		AND NOT NFX_CPU_PACKAGE_WIX)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Modern C++ CPU feature detection library with runtime capability detection")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_CPU_LICENSE_FILE})
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-cpu")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- DEB packages ---
	if(NFX_CPU_PACKAGE_DEB AND UNIX AND NOT APPLE)
	...
	# --- RPM packages ---
	if(NFX_CPU_PACKAGE_RPM AND UNIX AND NOT APPLE)
	...
	# --- WiX packages ---
	if(NFX_CPU_PACKAGE_WIX AND WIN32)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_CPU_LICENSE})
